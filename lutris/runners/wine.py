...
def _get_dlls_proton_warning(dlls_type: str) -> Callable[[str, LutrisConfig], Optional[str]]:
    ...
    Args:
        ...
        check_proton: Whether to check for Proton compatibility warning
    ...
    def check_warnings(_option_key: str, config: LutrisConfig) -> Optional[str]:
        try:
            ...
            if _is_pre_proton(_option_key, config) and runner_config.get(version_key) != "manual":
...
class wine(Runner):
    ...
    runner_options = [
        ...
        },
        {
            ...
            "default": "manual" if _is_pre_proton else lambda: DXVKManager().version,  # type: ignore[truthy-function]
        ...
        },
        {
            ...
            "default": "manual" if _is_pre_proton else lambda: VKD3DManager().version,  # type: ignore[truthy-function]
            "warring": _get_dlls_proton_warning("vkd3d"),
        },
        {
            "option": "d3d_extras",
            "section": _("Graphics"),
        ...
        },
        {
            ...
            "default": "manual" if _is_pre_proton else lambda: DXVKNVAPIManager().version,  # type: ignore[truthy-function]
